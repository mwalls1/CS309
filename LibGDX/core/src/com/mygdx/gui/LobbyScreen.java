...
public class LobbyScreen extends Game implements Screen {
	...
	public void create() {
		...
		privateGameButton.setPosition(Gdx.graphics.getWidth() / 2 - privateGameButton.getWidth() / 2,
				Gdx.graphics.getHeight() / 2 - Constants.BUTTON_OFFSET);
		publicGameButton.setPosition(Gdx.graphics.getWidth() / 2 - publicGameButton.getWidth() / 2,
				Gdx.graphics.getHeight() / 2 - Constants.BUTTON_OFFSET * 2);
		singlePlayerButton.setPosition(Gdx.graphics.getWidth() / 2 - singlePlayerButton.getWidth() / 2,
				Gdx.graphics.getHeight() / 2 - Constants.BUTTON_OFFSET * 3);
