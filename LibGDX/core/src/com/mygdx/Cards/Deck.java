...
public class Deck {
	...
	public void loadAllAssets() {
		...
		// Load joker cards
		for (int i = 1; i < 6; i++)
			manager.load("Cards/" + i + "joker.png", Texture.class);

		// Load card backs
		for (int i = 1; i < 5; i++)
			manager.load("Cards/" + i + "back.png", Texture.class);
