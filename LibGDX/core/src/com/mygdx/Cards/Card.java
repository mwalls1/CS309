...
public class Card {
	...
	public Card(AssetManager manager) // Generate a random card
	{
		...
		if (suitDetermine == 0)
			this.suit = "spades";
		else if (suitDetermine == 1)
			this.suit = "diamonds";
		else if (suitDetermine == 2)
			this.suit = "clubs";
		else if (suitDetermine == 3)
			this.suit = "hearts";

		if (rankDetermine <= 10)
			this.rank = "" + rankDetermine;
		else if (rankDetermine == 11)
			this.rank = "jack";
		else if (rankDetermine == 12)
			this.rank = "queen";
		else if (rankDetermine == 13)
			this.rank = "king";
