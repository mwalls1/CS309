...
public class MockitoTest extends Game {
	...
	public void testGetMoveHandling1() {
		...
		assertEquals(mockedGame.handleMove("temporaryUser asks p2 for 2"), "1 asks for 2");
	}
	...
	public void testGetMoveHandling2() {
		...
		assertFalse(newGame.handleMove(mockedGame.getMove()), "TemporaryUser asks p2 for 2");
	}
